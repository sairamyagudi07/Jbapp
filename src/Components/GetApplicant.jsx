...
//         // Check if the response is successful and contains applications
//         if (
...
//     fetchApplicants();
//   }, []);
//   console.log("get appl", applicants);

//   // Render loading state, error message, or applicants
//   if (isLoading) {
...
//                           <span className="px-2 py-1 rounded bg-green-500 text-white text-xs sm:text-sm">
//                             {app?.JobId || "Unknown"}
//                           </span>
//                         </div>
//                       </td>
...
//                   <p className="mt-2">
//                     <span
//                       className={`px-2 py-1 rounded text-white text-xs bg-green-500 ${app?.JobId}`}
//                     >
//                       {app?.JobId || "Unknown"}
//                     </span>
//                   </p>
